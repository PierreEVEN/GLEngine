...
public:
	...
	unsigned int GetIndicesCount() const { return (unsigned int)Indices.size(); }
	unsigned int GetNormalsCount() const { return (unsigned int)Normals.size(); }
	unsigned int GetUVsCount() const { return (unsigned int)UVs.size(); }
	unsigned int GetVertexColorsCount() const { return (unsigned int)VertexColors.size(); }
	unsigned int GetTangentsCount() const { return (unsigned int)Tangents.size(); }
};
